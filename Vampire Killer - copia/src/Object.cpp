...
Object::Object(const Point& p, ObjectType t, Vector2 levelIndex) : Entity(p, OBJECT_PHYSICAL_SIZE, OBJECT_PHYSICAL_SIZE, OBJECT_FRAME_SIZE, OBJECT_FRAME_SIZE)
{
    ...
    case ObjectType::KEY_CHEST:
        rc = { 12 * n,  7 * n, n, n }; 
        render = new StaticImage(data.GetTexture(Resource::IMG_TILES), rc);
        break;
    case ObjectType::KEY_DOOR:
        rc = { 13 * n,  7 * n, n, n }; 
        render = new StaticImage(data.GetTexture(Resource::IMG_TILES), rc);
        break;

    case ObjectType::CHEST_CHAIN:
        rc = { 11 * n,  7 * n, n, n }; 
        render = new StaticImage(data.GetTexture(Resource::IMG_TILES), rc);
        break;
    case ObjectType::CHEST_SHIELD:
        rc = { 11 * n,  7 * n, n, n }; 
        render = new StaticImage(data.GetTexture(Resource::IMG_TILES), rc);
        break;
    ...
    case ObjectType::FIRE:  
        sprite->SetAnimation((int)ObjectAnim::FIRE);
        break;
    case ObjectType::CANDLE:
        sprite->SetAnimation((int)ObjectAnim::CANDLE);
        break;
